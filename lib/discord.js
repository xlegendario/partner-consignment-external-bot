...
const EXTERNAL_CHANNEL_NAME = process.env.EXTERNAL_CHANNEL_NAME || "offer-inquiries"; // Offer & Confirm go here
const CONFIRM_CHANNEL_NAME  = process.env.CONFIRM_CHANNEL_NAME  || "offer-inquiries"; // same as above
